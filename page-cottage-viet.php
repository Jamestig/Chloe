<?php
/*
  Template Name: Cottage Page Vietnamese
*/
?>
  ...
  <main id="cottage-main">
    ...
    <section id="cottage-intro" class="section intro">
      <div class="container side-padding">
        <hgroup class="content has-text-centered">
          <h2 class="title">Viet emai Cottage</h2>
          <hr>
        ...
        <div class="columns">
          ...
          <div class="combine-inner column is-half is-one-third-desktop is-one-quarter-fullhd is-offset-1 is-offset-2-desktop">
            ...
            <div class="link-button-container">
              <a href="#" class="link-button">View rooms</a>
            </div>
          </div>
        </div>
      </article>
    ...
    <section id="cottage-rooms" class="section">
      <div class="content container">
        <header class="has-text-centered">
          <h2 class="title">cottage guestrooms</h2>
          <hr>
        </header>
        <div class="columns is-multiline">

          <section id="cottage-willow" class="column section is-full is-half-desktop">
          ...
          <section id="cottage-cocoon" class="column section is-full is-half-desktop">
            <article class="combine-container content">
              <div class="columns">
                <div class="combine-background column"></div>
                <div class="combine-inner column is-half is-offset-5">
