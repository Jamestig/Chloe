  ...
  <main id="emai-bnb-main" class="grey-ea">
    ...
    <section id="emai-bnb-attic" class="section">
      <div class="content">
        ...
        <div class="columns is-multiline">
          <section id="emai-bnb-clay" class="column room-section section is-full is-one-third-desktop">
            <h2 class="remove-header">Room Four</h2>
            <article class="combine-container content">
              <div class="columns">
          ...
          <section id="emai-bnb-willow" class="column room-section section is-full is-one-third-desktop">
          ...
          <section id="emai-bnb-cocoon" class="column room-section section is-full is-one-third-desktop">
